        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true, comment: ""),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextExecuteTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    LastExecuteTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, comment: "")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false, comment: "")
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LastWriteTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    Name = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false, comment: ""),
                    Code = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true, comment: ""),
                    IsEnable = table.Column<bool>(type: "boolean", nullable: false, comment: ""),
                    ExecuteTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastLoginTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorMessage = table.Column<string>(type: "text", nullable: true, comment: ""),
                    ExecuteStartTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    ExpressionTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    ExecuteEndTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false, comment: "")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpirationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, comment: ""),
