...
using NexusStack.EFCore.Repository.Query;
using System;
using System.Collections.Generic;
using System.Data;
using System.Text;

namespace NexusStack.EFCore.Repository.Base
{
    /// <summary>
    ...
    public interface IRepositoryBase<TEntity, TKey> : IQueryRepository<TEntity, TKey> where TEntity : class
    {
        ...
        /// <summary>
        /// Reset the PosContext state by removing all the tracked and attached entities.
        /// </summary>
        void ResetContextState();

        Task RollbackAsync(IDbContextTransaction transaction = null);
    }
}
