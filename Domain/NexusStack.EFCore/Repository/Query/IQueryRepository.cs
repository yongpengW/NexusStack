...
namespace NexusStack.EFCore.Repository.Query
{
    ...
    public interface IQueryRepository<TEntity, TKey> where TEntity : class
    {
        ...
        IQueryable<TEntity> GetQueryableIgnoreQueryFilters();

        /// <summary>
        /// 使用LinqKit扩展方法，获取可扩展的IQueryable LinqKit专用
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        IQueryable<TEntity> GetIgnoreQueryFiltersExpandable();
        ...
        Task<bool> ExistsWithSoftDeleteAsync(Expression<Func<TEntity, bool>> condition, CancellationToken cancellationToken = default);
